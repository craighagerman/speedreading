...
class mod_speedreading_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('static', 'label1', 'speedreadingsetting1', 'Your speedreading fields go here. Replace me!');

        $mform->addElement('header', 'speedreadingfieldset', get_string('speedreadingfieldset', 'speedreading'));
        $mform->addElement('static', 'label2', 'speedreadingsetting2', 'Your speedreading fields go here. Replace me!');
